...
/// @param hexContractCode: Hex-encoded updated contract code
///
transaction(contractName: String, hexContractCode: String) {
    ...
    execute {
        ...
        MigrationContractStaging.stageContract(host: self.host, name: contractName, code: String.fromUTF8(hexContractCode.decodeHex())!)
    }
